module id_ex_pipe(immext_ex, rdata1_ex, rdata2_ex, rd_ex, pc_ex, pcplus4_ex, regw_ex, alusrc_ex, memw_ex, branch_ex, jump_ex, jumpreg_ex, aluctrl_ex, resultsrc_ex, rs1_ex, rs2_ex, clk, flush, reset,immext_id, rdata1_id, rdata2_id, rd_id, pc_id, pcplus4_id, regw_id, alusrc_id, memw_id, branch_id, jump_id, jumpreg_id, aluctrl_id, resultsrc_id, rs1_id, rs2_id);

    input clk, reset, flush, regw_id, memw_id, branch_id, jump_id, jumpreg_id, alusrc_id;
